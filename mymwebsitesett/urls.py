...
urlpatterns += i18n_patterns(
    ...
    url(r'^cases/salperctrl/$', TemplateView.as_view(template_name="cases/salperctrl.html"), name='salpercrtl'),
    ...
    url(r'^howto/salperctrl/$', TemplateView.as_view(template_name="howto/salperctrl.html"), name='salpercrtlhowto'),
